 ...
 * @author Computação
 */
public class IndexEstagiarios extends javax.swing.JFrame {

    /**
     * Creates new form Estagiarios
     */
    public IndexEstagiarios() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndexEstagiarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IndexEstagiarios().setVisible(true);
            }
        });
    }
