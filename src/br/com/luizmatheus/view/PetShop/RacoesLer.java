 ...
 * @author t-gamer
 */
public class RacoesLer extends javax.swing.JFrame {

    /**
     * Creates new form RacoesLer
     */
    public RacoesLer() {
        initComponents();
    ...
    private void btLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLerActionPerformed
        ...
        try {
            ler.lerRacao(txNomeArq.getText());
        } catch (IOException ex) {
            Logger.getLogger(RacoesLer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RacoesLer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
