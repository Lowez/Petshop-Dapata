 ...
 * @author t-gamer
 */
public class RoupasLer extends javax.swing.JFrame {

    /**
     * Creates new form RoupasLer
     */
    public RoupasLer() {
        initComponents();
    ...
    private void btLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLerActionPerformed
        ...
        try {
            ler.lerRoupa(txNomeArq.getText());
        } catch (IOException ex) {
            Logger.getLogger(RoupasLer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoupasLer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
