 ...
 * @author Computação
 */
public class Banhos extends javax.swing.JFrame {

    /**
     * Creates new form Banhos
     */
    public Banhos() {
        initComponents();
    ...
    private void btLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLerActionPerformed
        BanhoLer ler = new BanhoLer();
        ler.show();
    }//GEN-LAST:event_btLerActionPerformed

    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        BanhoRemover remover = new BanhoRemover();
        remover.show();
    }//GEN-LAST:event_btRemoverActionPerformed

    private void btIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btIncluirActionPerformed
        BanhoAdicionar adicionar = new BanhoAdicionar();
        adicionar.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Banhos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
