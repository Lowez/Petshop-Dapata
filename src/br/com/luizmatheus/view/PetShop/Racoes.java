 ...
 * @author Computação
 */
public class Racoes extends javax.swing.JFrame {

    /**
     * Creates new form Racoes
     */
    public Racoes() {
        initComponents();
    ...
    private void btLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLerActionPerformed
        RacoesLer ler = new RacoesLer();
        ler.show();
    }//GEN-LAST:event_btLerActionPerformed

    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        RacoesRemover remover = new RacoesRemover();
        remover.show();
    }//GEN-LAST:event_btRemoverActionPerformed

    private void btIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btIncluirActionPerformed
        RacoesAdicionar adicionar = new RacoesAdicionar();
        adicionar.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Racoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
