 ...
 * @author t-gamer
 */
public class BanhoLer extends javax.swing.JFrame {

    /**
     * Creates new form BanhoLer
     */
    public BanhoLer() {
        initComponents();
    ...
    private void btLerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLerActionPerformed
        ...
        String nome_arq = (txNomeArq.getText());
        try {
            ler.lerBanho(nome_arq);
        } catch (IOException ex) {
            Logger.getLogger(BanhoLer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanhoLer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
